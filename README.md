...
```hcl
github.com/pbs/terraform-aws-elasticache-redis-standalone-module?ref=3.0.1
```
...
```hcl
module "redis" {
  source = "github.com/pbs/terraform-aws-elasticache-redis-standalone-module?ref=3.0.1"
